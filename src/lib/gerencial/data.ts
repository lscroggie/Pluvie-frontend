...
// mes, donde el eje X son semanas). PLACEHOLDER ilustrativo: no son eventos
// reales, no existe hoy un campo de "eventos/anotaciones" cargado por
// gerencial. Reemplazar por datos reales cuando ese campo exista.
export const SAMPLE_CHART_ANNOTATIONS: ChartAnnotation[] = [
  { pointLabel: "Sem 2", label: "Campaña de invierno (ejemplo, no es un evento real)" },
];
